...
export const BloodPressureDetailPage: React.FC = () => {
  ...
  const loadRecords = () => {
    const bpRecords = healthDataService.getRecordsByType('bloodPressure');
    setRecords(bpRecords);
  };
    ...
    <div className="min-h-screen bg-white">
      <header className="bg-white border-2 border-black rounded-none">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-black uppercase">血压详情</h1>
            <p className="text-black">跟踪你的血压变化趋势</p>
          </div>
